    ...
    define([
        ...
        return function(
            ...
            var $accountSettingsElement, userAccountModel, userPreferencesModel, aboutSectionsData,
                ...
                urfuGroupFieldView, urfuGroupFieldData;
            ...
            urfuGroupFieldData = {
                model: userAccountModel,
                title: gettext('Full Name'),
                valueAttribute: 'urfu_group',
                helpMessage: gettext('UrFU student group.'),  // eslint-disable-line max-len,
                persistChanges: true
            };

            urfuGroupFieldView = {
                view: new AccountSettingsFieldViews.TextFieldView(urfuGroupFieldData)
            };
